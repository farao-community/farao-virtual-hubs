...
class VirtualHubsConfigurationServiceTest {
    ...
    public void myTest() {
        try (VirtualHubsConfigurationService service = new VirtualHubsConfigurationService("localhost", 8080)) {
            service.publish(getClass().getResourceAsStream("/virtualHubsConfigurationFile.xml"), LocalDateTime.parse("2016-11-09T11:44:44"), LocalDateTime.parse("2026-11-09T11:44:44"));
